...
export const TOGGLE_COMPARED_LIST = "TOGGLE_COMPARED_LIST"
...
export const addAsyncButton = asyncButtonId => ({
    type: ADD_ASYNC_BUTTON,
    payload: {asyncButtonId}
})
export const remvoeAsyncButton = asyncButtonId => ({
    type: REMOVE_ASYNC_BUTTON,
    payload: {asyncButtonId}
})
