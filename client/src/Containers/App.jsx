...
background-color:${({theme, mainColor}) => mainColor || theme.palette.background.default};
`;
...
class App extends Component {
    ...
    mobilecheck = () => {
        ...
        this.props.setDeviceType(check);
    };
...
const mapStateToProps = state => {
    return {
        ...
        mainColor: state.animations.main.color,
    }
}
