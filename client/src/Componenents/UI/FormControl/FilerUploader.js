                ...
                >
                    {
                        this.state.DnD ?
                            <div>
                                < div>
                                    < Grow in={true} key={files ? "add" : "append"} timeout={300}>
                                        <Icon className="icon" color="primary"> {files ? "add" : "cloud_upload"} </Icon>
                                    </Grow>
                                </div>
                                <Fade in={true} key={files ? "add" : (files || []).length} timeout={300}>
                                    <Typography>{files ? ` ${files.length} files uploaded add more` : "Drag Files To Upload"}</Typography>
                                </Fade>
                            </div>
                            :
